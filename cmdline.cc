...
struct custom_option custom_opts[] = {
	...
	{{ "execute_fd", no_argument, NULL, 0x0607 },
	...
	{{ "max_cpus", required_argument, NULL, 0x508 },
	...
	{{ "cap", required_argument, NULL, 0x0509 },
	...
	{{ "rlimit_as", required_argument, NULL, 0x0201 },
	...
	{{ "rlimit_core", required_argument, NULL, 0x0202 },
	...
	{{ "rlimit_cpu", required_argument, NULL, 0x0203 },
	...
	{{ "rlimit_fsize", required_argument, NULL, 0x0204 },
	...
	{{ "rlimit_nofile", required_argument, NULL, 0x0205 },
	...
	{{ "rlimit_nproc", required_argument, NULL, 0x0206 },
	...
	{{ "rlimit_stack", required_argument, NULL, 0x0207 },
	...
	{{ "disable_clone_newnet", no_argument, NULL, 'N' },
	...
	{{ "bindmount", required_argument, NULL, 'B' },
	...
	{{ "tmpfsmount", required_argument, NULL, 'T' },
	...
	{{ "macvlan_vs_ma", required_argument, NULL, 0x705 },
	 "MAC-address of the 'vs' interface (e.g. \"ba:ad:ba:be:45:00\")" },
	{{ "record_usage", no_argument, NULL, 0x1000 }, "Record CPU & memory usage statistics" },
};
// clang-format on
...
std::unique_ptr<nsjconf_t> parseArgs(int argc, char* argv[]) {
	...
	nsjconf->report_usage = false;

	nsjconf->user_cpu_usage = 0;
	nsjconf->system_cpu_usage = 0;
	nsjconf->memory_usage = 0;
